...
class TestRingBuilder(unittest.TestCase):
    ...
    def test_no_duplicate_assignments(self):
        ...
        rb.add_dev({'id': 0, 'region': 0, 'zone': 0, 'weight': s1_weight,
                    'ip': '10.0.0.1', 'port': 10000, 'device': 'sda'})
        rb.add_dev({'id': 1, 'region': 0, 'zone': 0, 'weight': s1_weight,
                    'ip': '10.0.0.1', 'port': 10000, 'device': 'sdb'})
        rb.add_dev({'id': 2, 'region': 0, 'zone': 0, 'weight': s1_weight,
                    'ip': '10.0.0.1', 'port': 10000, 'device': 'sdc'})
        rb.add_dev({'id': 3, 'region': 0, 'zone': 0, 'weight': s1_weight,
                    'ip': '10.0.0.1', 'port': 10000, 'device': 'sdd'})
        rb.add_dev({'id': 4, 'region': 0, 'zone': 0, 'weight': s1_weight,
                    'ip': '10.0.0.1', 'port': 10000, 'device': 'sde'})
        rb.add_dev({'id': 5, 'region': 0, 'zone': 0, 'weight': s1_weight,
                    'ip': '10.0.0.1', 'port': 10000, 'device': 'sdf'})

        rb.add_dev({'id': 10, 'region': 0, 'zone': 0, 'weight': s2_weight,
                    'ip': '10.0.0.2', 'port': 10000, 'device': 'sda'})
        rb.add_dev({'id': 11, 'region': 0, 'zone': 0, 'weight': s2_weight,
                    'ip': '10.0.0.2', 'port': 10000, 'device': 'sdb'})
        rb.add_dev({'id': 12, 'region': 0, 'zone': 0, 'weight': s2_weight,
                    'ip': '10.0.0.2', 'port': 10000, 'device': 'sdc'})
        rb.add_dev({'id': 13, 'region': 0, 'zone': 0, 'weight': s2_weight,
                    'ip': '10.0.0.2', 'port': 10000, 'device': 'sdd'})
        rb.add_dev({'id': 14, 'region': 0, 'zone': 0, 'weight': s2_weight,
                    'ip': '10.0.0.2', 'port': 10000, 'device': 'sde'})
        rb.add_dev({'id': 15, 'region': 0, 'zone': 0, 'weight': s2_weight,
